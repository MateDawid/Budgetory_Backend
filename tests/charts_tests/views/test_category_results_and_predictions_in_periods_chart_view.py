...
def category_results_predictions_chart_url(wallet_id: int) -> str:
    """Create and return a category results and predictions chart URL."""
    return reverse("charts:category-results-and-predictions-in-periods-chart", args=[wallet_id])
...
class TestCategoryResultsAndPredictionsInPeriodsChartApiView:
    ...
    def test_user_not_wallet_member(
        ...
        """
        GIVEN: Wallet instance in database.
        WHEN: CategoryResultsAndPredictionsInPeriodsChartApiView called with GET by User not belonging to given Wallet.
    ...
    def test_get_chart_data_empty_wallet(
        ...
        response = api_client.get(category_results_predictions_chart_url(wallet.id), {"category": str(category.id)})
    ...
    def test_get_chart_data_no_transfers_or_predictions(
        ...
        """
        GIVEN: Wallet with periods but no transfers or predictions in database.
    ...
    def test_get_chart_data_basic_scenario(
        ...
        """
        GIVEN: Wallet with periods, transfers, and predictions for a category.
        WHEN: CategoryResultsAndPredictionsInPeriodsChartApiView called by Wallet member.
    ...
    def test_get_chart_data_only_results(
        ...
        """
        GIVEN: Wallet with period containing only transfers (no predictions).
        WHEN: CategoryResultsAndPredictionsInPeriodsChartApiView called by Wallet member.
    ...
    def test_get_chart_data_only_predictions(
        ...
        """
        GIVEN: Wallet with period containing only predictions (no transfers).
        WHEN: CategoryResultsAndPredictionsInPeriodsChartApiView called by Wallet member.
    ...
    def test_get_chart_data_decimal_precision(
        ...
        """
        GIVEN: Wallet with transfers and predictions containing decimal values.
        WHEN: CategoryResultsAndPredictionsInPeriodsChartApiView called by Wallet member.
    ...
    def test_get_chart_data_large_values(
        ...
        """
        GIVEN: Wallet with transfers and predictions containing large monetary values.
        WHEN: CategoryResultsAndPredictionsInPeriodsChartApiView called by Wallet member.
    ...
    def test_display_value_results_only(
        ...
        """
        GIVEN: Wallet with transfers and predictions for a category.
        ...
        response = api_client.get(
            category_results_predictions_chart_url(wallet.id),
    ...
    def test_display_value_invalid_value(
        ...
        """
        GIVEN: Wallet with transfers and predictions.
        ...
        response = api_client.get(
            category_results_predictions_chart_url(wallet.id), {"category": str(category.id), "display_value": "999"}
        )
    ...
    def test_periods_count_parameter_one(
        ...
        """
        GIVEN: Wallet with multiple periods, transfers, and predictions.
    ...
    def test_nonexistent_category(
        ...
        nonexistent_id = TransferCategory.objects.filter(wallet=wallet).order_by("-id").first().id + 1

        response = api_client.get(category_results_predictions_chart_url(wallet.id), {"category": str(nonexistent_id)})
    ...
    def test_income_category(
        ...
        """
        GIVEN: Wallet with income category and transfers.
        ...
        response = api_client.get(
            category_results_predictions_chart_url(wallet.id), {"category": str(income_category.id)}
        )
    ...
    def test_mixed_periods_with_and_without_data(
        ...
        """
        GIVEN: Wallet with multiple periods, some with data and some without.
        WHEN: CategoryResultsAndPredictionsInPeriodsChartApiView called by Wallet member.
    ...
    def test_category_empty_string(
        ...
        response = api_client.get(category_results_predictions_chart_url(wallet.id), {"category": ""})
