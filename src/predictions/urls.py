...
from predictions.views.deposits_results_view import DepositsResultsAPIView

app_name = "predictions"

urlpatterns = [
    path("deposits_results/<int:period_pk>/", DepositsResultsAPIView.as_view(), name="deposits-results"),
    path(
