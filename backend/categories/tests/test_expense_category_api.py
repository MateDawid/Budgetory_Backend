...
#         for _ in range(2):
#             expense_category_factory(budget=budget, category_type=category_type)
#
#         response = api_client.get(url(budget.id))
#
#         categories = ExpenseCategory.objects.filter(budget=budget, category_type=category_type.value)
...
#         """
#         budget = budget_factory(owner=base_user)
#         category = expense_category_factory(budget=budget, category_type=category_type)
#         expense_category_factory(category_type=category_type)
#         api_client.force_authenticate(base_user)
#
#         response = api_client.get(url(budget.id))
#
