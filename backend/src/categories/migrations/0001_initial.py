    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        choices=[(0, "Incomes"), (1, "Most important"), (2, "Debts"), (3, "Savings"), (4, "Others")]
                    ),
                ),
                (
                    "budget",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    models.Q(("category_type", 0), ("priority", 0)),
                    models.Q(("category_type", 1), models.Q(("priority", 0), _negated=True)),
                    _connector="OR",
                ),
